...
open class PXGoogleDirectionsRouteLegStep: NSObject, PXGoogleDirectionsSteppable {
	...
	open var distance: PXGoogleDirectionsDistance?
	/// Typical time required to perform the step, until the next step
	open var duration: PXGoogleDirectionsDuration?
	/// Location of the starting point of this step
	open var startLocation: CLLocationCoordinate2D?
	/// Location of the last point of this step,
	open var endLocation: CLLocationCoordinate2D?
	...
	open var rawInstructions: String? {
